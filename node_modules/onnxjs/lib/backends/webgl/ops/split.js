...
var WebGLSplit = /** @class */ (function (_super) {
    ...
    WebGLSplit.prototype.run = function (inferenceHandler, inputs) {
        var _this = this;
        var count = this.getProgramCount(inferenceHandler, inputs);
        if (!this.artifacts) {
            this.artifacts = [];
            for (var i = 0; i < count; ++i) {
                var programInfo = this.createProgramInfo(inferenceHandler, inputs[0], i);
    ...
    WebGLSplit.prototype.getProgramCount = function (inferenceHandler, inputs) {
        var _a = __read(util_1.SplitUtil.splitShape(inputs[0].dims, this.axis, this.split, this.numOutputs), 2), offsets = _a[1];
        return offsets.length;
    };
    WebGLSplit.prototype.createProgramInfo = function (inferenceHandler, input, index) {
        var _a = __read(util_1.SplitUtil.splitShape(input.dims, this.axis, this.split, this.numOutputs), 2), shapes = _a[0], offsets = _a[1];
