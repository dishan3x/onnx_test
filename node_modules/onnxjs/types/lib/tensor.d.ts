...
export declare class Tensor {
     ...
     */
    readonly integerData: Tensor.IntegerType;
    /**
     * get the underlying float tensor data. Should only use when type is one of the following: (FLOAT, DOUBLE)
     */
    readonly floatData: Tensor.FloatType;
    /**
     * get the underlying number tensor data. Should only use when type is one of the following: (UINT8, INT8, UINT16,
     * INT16, INT32, UINT32, BOOL, FLOAT, DOUBLE)
     */
    readonly numberData: Tensor.NumberType;
    /**
     ...
     * get the type of the tensor
     */
    type: Tensor.DataType, dataProvider?: DataProvider | undefined, asyncDataProvider?: AsyncDataProvider | undefined, cache?: Uint8Array | string[] | Float32Array | Int32Array | Uint32Array | Float64Array | Int8Array | Int16Array | Uint16Array | undefined, 
    /**
     * get the data ID that used to map to a tensor data
     */
    dataId?: Tensor.Id);
